import { LaptopType } from "@/app/constants";
...
interface laptopProps {
  productLaptop: LaptopType;
}

const GamingLaptopList = ({ productLaptop }: laptopProps) => {
  const { addToCart } = useCart();
  const discount = Math.round(
    ((productLaptop.mrp - productLaptop.price) / productLaptop.mrp) * 100,
  );
  return (
    <div>
      <div className="p-4">
...
export default GamingLaptopList;
