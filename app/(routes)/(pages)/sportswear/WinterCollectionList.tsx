import { winterColletionType } from "@/app/constants";
...
interface winterCollectionProps {
  productWinter: winterColletionType;
}

const WinterCollectionList = ({ productWinter }: winterCollectionProps) => {
  const { addToCart } = useCart();
  const discount = Math.round(
    ((productWinter.mrp - productWinter.price) / productWinter.mrp) * 100,
  );
  return (
    <div>
      <div>
            ...
            <CardFooter className="px-0 pb-0 pt-2">
              <Button
                ...
                onClick={() => {
                  addToCart({
                    id: productWinter.id,
                    title: productWinter.title,
                    price: productWinter.price,
                    image: productWinter.image1,
                  });
...
export default WinterCollectionList;
